...
dropbox %>%
  ...
  ggplot(aes(x = willing_to_switch_task, y = perc, fill = willing_to_switch_task)) + geom_col() + labs(y = "Ratio", x = "If you are willing to switch to Dropbox for task management features", title = "Willing to switch to Dropbox for task management features") +
  theme(legend.position = "none")
